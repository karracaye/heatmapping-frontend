...
const Settings = () => {
  ...
  let settingContent = <p className="text-black text-sm text-center">No Selected Setting yet...</p>;
  ...
  if(selectedSetting){
    ...
    return (
      <div className="flex flex-grow border-[1px] rounded-lg m-3 shadow-md h-auto">
        <div className="flex flex-col pl-10 pr-10 pt-6 pb-32 rounded-bl-lg rounded-tl-lg shadow-md border">
          <label className="text-2xl font-bold border-b-[2px] pb-3 pt-3 pr-28">
            Settings
          </label>
          <div className="flex flex-col mt-5 mb-3">
            ...
            <text
              ...
              onClick={() => handleOnClick("user-management")}
            >
              User Management
            </text>
            <text
            ...
            <text
              className={`${styles.textList} ${
                selectedSetting === "clickable-data-points"
                  ? styles.active
                  : null
              } text-xs text-black cursor-pointer pb-2 pt-2 pl-9`}
            ...
            <text
              className={`${styles.textList} ${
                selectedSetting === "alert-configurations"
                  ? styles.active
                  : null
              } text-xs text-black cursor-pointer pb-2 pt-2 pl-9`}
        ...
        <div className="flex flex-1 h-auto w-full p-10">{settingContent}</div>
      </div>
    );
};
