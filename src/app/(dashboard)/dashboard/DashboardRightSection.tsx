...
useEffect(() => {
   ...
   return (
      <div className='w-[100%] min-h-[83vh] grow pt-5 pl-[3%] pr-[2.5%]'>
         <div className='min-h-[100%] grid grid-cols-3 grid-rows-3 gap-3'>
            <div className='col-span-2 row-span-2 rounded-[10px] shadow-[0_1px_2.9px_0_rgba(0,0,0,0.25)] bg-white flex flex-row'>
                  <div className='w-[73%]'>
               ...
               <div className='col-span-1 row-span-2 rounded-[10px] shadow-[0_1px_2.9px_0_rgba(0,0,0,0.25)] flex flex-col bg-white'>
               ...
               <div className='col-span-2 row-span-1 rounded-[10px] shadow-[0_1px_2.9px_0_rgba(0,0,0,0.25)] bg-white'>
                     
               </div>
               <div className='col-span-1 row-span-1 rounded-[10px] shadow-[0_1px_2.9px_0_rgba(0,0,0,0.25)] bg-white'>
               </div>
            </div>
      </div>
   )
