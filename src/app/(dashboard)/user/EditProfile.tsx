      ...
      {editProfileOpen && (
         <>
            ...
            <div className={`w-[557px] h-[100vh] bg-white flex flex-col absolute right-0 top-0 bottom-0 transition duration-300 ease-in-out `}>
               <div className='mt-[30px] px-[5%] w-full flex flex-row items-start justify-between'>
                  <div>
                     <h3 className='font-medium text-[15px]'>Edit Profile</h3>
                     <p className='font-normal text-[13px] opacity-50 text-black mt-1'>Please fill up the following information</p>
                  </div>
            ...
            {deactivateChoice &&<section className='absolute w-full h-full flex items-center justify-center top-0 right-0 left-0 bottom-0 z-10'>
                  ...
                  <div className='w-[380px] h-[260px] bg-white rounded-[10px] z-10 flex flex-col justify-center items-center shadow-[0_4px_4px_0_rgba(0,0,0,0.25)]'>
                     ...
                     <p className='font-medium text-center text-base text-black'>Are you sure you want to <span className='text-[#FFA500]'>deactivate</span> <br/>this accoung?</p>
                     <div className='mt-5'>
                        <button onClick={() => setDeactivateChoice(false)} className='w-[90px] h-[45px] rounded-[10px] bg-[#F5C8C1] font-medium text-sm text-white cursor-pointer'>No</button>
                        <button className='w-[90px] h-[45px] ml-4 rounded-[10px] bg-[#303179] font-medium text-sm text-white cursor-pointer'>Yes</button>
                     </div>
                  </div>
            </section>}
            {deleteChoice && <section className='absolute w-full h-full flex items-center justify-center top-0 right-0 left-0 bottom-0 z-10'>
                  <div className='absolute top-0 right-0 bottom-0 left-0 bg-[#0000004d]'>
                  </div>
                  <div className='w-[380px] h-[260px] bg-white rounded-[10px] z-10 flex flex-col justify-center items-center shadow-[0_4px_4px_0_rgba(0,0,0,0.25)]'>
                     <img className='h-[82px] w-[82px]' src="/icon/deleteWarning.svg" alt="" />
