...
const DashBoardRIghtSection = () => {
   ...
   const handleTypeOfServices = (type: string) => {
      setReqType(type);
   };
   return (
         ...
         <div className='rounded-[10px] shadow-[0_1px_2.9px_0_rgba(0,0,0,0.25)] bg-white flex flex-row'>
            <div className='w-[73%] h-[100%]'>
               <div className='ml-[43px] mt-[15px] relative'>
                  ...
                  <img className='h-[99px] w-[23px] mt-[150px] ml-[-4%]' src="../icon/group12.svg"/>
                  <img className='w-[422px] h-[310px] absolute top-0 pl-[11%]' src="../images/map.svg"/>
               </div>
            </div>
