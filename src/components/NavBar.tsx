...
const Navbar = () => {
  ...
  return (
    <nav>
        <div className="w-full px-[3%]">
            <div className='w-[105px] h-[35px] flex flex-row mt-[20px] ml-[92%]'onClick={toggleNotifications}>
              <img src="../icon/group6.svg" className='w-[30px] h-[30px]'/>
            ...
            <div className='hover:bg-gray-100 px-1 p-4 border-b-2'>  
              <div className='flex gap-1 px-4'>
                <div className='flex p-4 justify-center items-center rounded-full bg-[#D9D9D9] h-[50px] w-[50px]'>
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><g fill="none" stroke="#ffffff" strokeWidth="2"><path strokeLinejoin="round" d="M4 18a4 4 0 0 1 4-4h8a4 4 0 0 1 4 4a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2z"/><circle cx="12" cy="7" r="3"/></g></svg>
                </div>
  
                <div className='flex-grow px-2'>
                  <div className='flex justify-between'>
                    <p className='text-sm py-1'>{notification.title}</p>
                    <p className='text-xs text-right opacity-50'>{notification.time}</p>
                  </div>
                  <p className='text-xs opacity-50'>{notification.description}</p>
                </div>
              </div>
            </div>
              ...
              <div className='p-3 bg-[#303079] rounded-b-xl '>
                <p className='text-sm text-white text-center cursor-pointer'> View All</p>
              </div>
            </div>
      )}
